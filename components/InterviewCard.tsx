...
const InterviewCard = ({ interviewId, userId, role, type, techstack, createdAt,
    ...
    const formattedDate = dayjs(feedback?.createdAt || createdAt ||
        Date.now()).format('MMM D,YYY');

    return (
        <div className="caret-border w-[360px] max-sm:w-full min-h-96">
            <div className="card-interview">
                <div>
                    ...
                    <Image src={getRandomInterviewCover()} alt="cover-image" width={90}
                        height={90} className="rounded-full object-fit" />
